...
(async () => {
    try {
        ...
        articles = [...firebaseArticles, ...userArticles, ...defaultArticles];
        renderArticles(articles);
    } catch (e) {
        console.error("Gagal memuat artikel dari Firebase:", e);
        articles = [...userArticles, ...defaultArticles];
        renderArticles(articles);
    }
})();
...
if (fontSizeSelect) {
    fontSizeSelect.addEventListener("change", () => {
        document.body.style.fontSize = fontSizeSelect.value === "large" ? "18px" : fontSizeSelect.value === "xlarge" ? "20px" : "16px";
